...
use KMA\Modules\KMAInstagram\InstagramController;
        ...
        <div class="container is-fluid">
            <div class="content">
                <?php
                    ...
                    if (isset($_POST['instagram_submit_secret_settings']) && $_POST['instagram_submit_secret_settings'] == 'yes') {
                        update_option('instagram_app_secret',
                            isset($_POST['instagram_app_secret']) ? sanitize_text_field($_POST['instagram_app_secret']) : $FacebookSecret);
                    }

                     // Save App Secret

                    if(!get_option('instagram_app_secret')){ ?>
                        <h4 id="secret-headline" class="mt-5">Assign App Secret</h4>
                        <p class="is-small">If you don't have this, ask your developer.</p>
        
                        <form enctype="multipart/form-data" name="instagram_secret_settings" id="instagram_secret_settings" method="post"
                            action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>">
                            <input type="hidden" name="instagram_submit_secret_settings" value="yes">
        
                            <div class="field has-addons">
                                <div class="control">
                                    <input type="text" class="input is-small" name="instagram_app_secret" id="instagram_app_secret"
                                        value="<?= $instagramSecret; ?>" style="font-size: .83rem; width: 250px;" >
                                </div>
                                <div class="control">
