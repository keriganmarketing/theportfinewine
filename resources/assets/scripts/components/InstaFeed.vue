<template>
    <div class="instafeed row no-gutters">
        <div v-for="item in feedData" :key="item.id" class="col-6 col-md-4 col-xl-3 bg-dark" >
            <div class="image-container">
            <img :src="item.large" >
            </div>
        </div>
        <div class="col-6 col-md-8 col-xl-3 text-center" >
